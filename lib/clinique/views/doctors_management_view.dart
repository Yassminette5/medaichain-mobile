                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: CircleAvatar(
                        backgroundColor: AppTheme.primaryMedical.withValues(alpha: 0.1),
                        child: Text(
                          initial.toUpperCase(),
        ...
        ElevatedButton(
          ...
          onPressed: _selectedDoctorId == null || _selectedSpeciality == null ? null : () async {
            try {
              ...
              final String email = (selectedDoc['email'] ?? '').toString();
              final String fullName = (selectedDoc['fullName'] ?? selectedDoc['name'] ?? email).toString();
