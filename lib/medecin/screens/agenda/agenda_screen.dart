...
class _AgendaScreenState extends State<AgendaScreen> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: TableCalendar<CalendarEvent>(
        ...
        onPageChanged: (focusedDay) {
          provider.setFocusedDay(focusedDay);
          // Load month events (backend: GET /appointments/month)
          provider.loadEventsForMonth(focusedDay);
        },
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(isEditing ? 'Événement modifié Ô£ô' : 'Événement ajouté Ô£ô'),
  ...
  void _showAddConsultationDialog(BuildContext context) {
    final provider = Provider.of<CalendarProvider>(context, listen: false);
    // debugPrint('Agenda: opening consultation dialog for date: ${provider.selectedDay}');
    ...
    try {
      ...
      debugPrint('Agenda: error opening dialog: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
