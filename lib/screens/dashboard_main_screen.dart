                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Déconnexion réussie. À bientôt !'), backgroundColor: AppTheme.success),
                    );
                    // TODO: Navigate to Login screen when it's built
                  },
        ...
        child: Row(
          children: [
            Icon(
              ...
              color: isLogout 
                  ? AppTheme.error 
                  : (isSelected ? AppTheme.primaryMedical : Colors.grey[600]),
              size: 22,
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Text(
                ...
                style: GoogleFonts.plusJakartaSans(
                  color: isLogout 
                      ? AppTheme.error 
                      : (isSelected ? AppTheme.primaryMedical : Colors.grey[700]),
                  fontSize: 14,
