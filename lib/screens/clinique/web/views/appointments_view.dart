...
class _AppointmentsViewState extends State<AppointmentsView> {
                        ...
                        child: Form(
                          ...
                          child: AnimatedSwitcher(
                            ...
                            child: _currentStep == 0
                                ? _buildStep1Patient(nameCtrl, phoneCtrl, selectedType, consultationTypes, setDialogState, (v) => selectedType = v)
                                : _currentStep == 1
  ...
  // ── STEP 1: Patient & Type ──
  Widget _buildStep1Patient(TextEditingController nameCtrl, TextEditingController phoneCtrl, String selectedType, List<Map<String, dynamic>> types, StateSetter ss, Function(String) onTypeChanged) {
    return Column(
            ...
            return InkWell(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: isSelected ? [BoxShadow(color: (t['color'] as Color).withOpacity(0.1), blurRadius: 8, offset: const Offset(0, 2))] : [],
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(t['icon'] as IconData, size: 18, color: isSelected ? t['color'] as Color : AppTheme.textSecondary),
                    const SizedBox(width: 8),
                    Text(t['label'] as String, style: GoogleFonts.plusJakartaSans(fontSize: 13, fontWeight: isSelected ? FontWeight.w700 : FontWeight.w500, color: isSelected ? t['color'] as Color : AppTheme.textSecondary)),
                  ],
                ),
              ),
            );
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(appt['patientName'] ?? 'Patient', style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w700, color: AppTheme.darkNavy)),
                                const SizedBox(height: 2),
                                Text('Dr. ${appt['doctorName'] ?? '-'} • ${appt['reason'] ?? ''}', style: GoogleFonts.plusJakartaSans(fontSize: 12, color: AppTheme.textSecondary)),
                              ],
                            ),
                          ),
                          Container(
