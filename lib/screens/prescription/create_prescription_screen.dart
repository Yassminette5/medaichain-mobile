...
class _CreatePrescriptionScreenState extends State<CreatePrescriptionScreen> {
  ...
  Widget _buildPatientHeader() {
    return MedicalCard(
      ...
      child: Row(children: [
        CircleAvatar(radius: 24, backgroundColor: AppColors.prescription.withValues(alpha: 0.2), child: const Text('JD', style: TextStyle(color: AppColors.prescription, fontWeight: FontWeight.bold))),
        const SizedBox(width: 16),
        const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Jean Dupont', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)), SizedBox(height: 4), Text('Allergies: Pénicilline, Arachides', style: TextStyle(color: AppColors.error, fontSize: 12, fontWeight: FontWeight.w500))])),
