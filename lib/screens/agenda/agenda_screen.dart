                        ...
                        Consumer<PatientsProvider>(
                          builder: (context, patientsProvider, child) {
                            ...
                            return Autocomplete<String>(
                              initialValue: TextEditingValue(text: patientController.text),
                              optionsBuilder: (TextEditingValue textEditingValue) {
                                if (textEditingValue.text.isEmpty) {
                                  return patients.map((p) => p.fullName);
                                }
                                return patients
                                    .map((p) => p.fullName)
                              ...
                              onSelected: (String selection) {
                                setSheetState(() {
                                  patientController.text = selection;
                                });
                              },
                                ...
                                return Align(
                                  ...
                                  child: Material(
                                    ...
                                    child: Container(
                                      ...
                                      width: MediaQuery.of(context).size.width - 48, // Ajustement de la largeur
                                      decoration: BoxDecoration(
                                        color: AppColors.surface,
                                        borderRadius: BorderRadius.circular(16),
                                          ...
                                          return InkWell(
                                            ...
                                            child: Container(
                                              ...
                                              child: Text(
                                                option,
                                                style: const TextStyle(
                                                  color: AppColors.textPrimary, // Force la couleur du texte
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.w500,
                                                ),
                                              ),
