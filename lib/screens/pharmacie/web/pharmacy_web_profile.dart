...
class _PharmacyWebProfileState extends State<PharmacyWebProfile> {
  ...
  Future<void> _loadProfile() async {
    try {
      ...
      // Ensure delivery and notification fields are properly set
      profile['hasDelivery'] = profile['hasDelivery'] ?? false;
      profile['hasNotifications'] = profile['hasNotifications'] ?? true;
